...
public class ProductService extends BaseService<Product> {
	...
	public ProductService(ProductImageService productImageService, ProductRepository productRepository) {
...
//				sql += " and p.status=1 ";
	...
	public List<Product> getProductsByCategory(int categoryId) {
		return (List<Product>) productRepository.findByCategoriesId(categoryId);
	}
}
