		...
		<div class="contact">
			...
			<div class="call">
				...
				<div class="call-title">
					Hỗ trợ / Mua hàng: <span class="call-phone">0928475944</span>
				</div>
			</div>
		</div>
	...
	<div class="introduc">
		<div class="introduc-content">
			...
			<div class="introduc-logo">
				<div>TẤT CẢ CÁC SẢN PHẨM ĐỀU ĐƯỢC PHÂN PHỐI ĐỘC QUYỀN BỞI HOUJI PHOTO</div>
				<a href="${base }"> <img src="${base }/img/title.png" width="30%">
				</a>
			</div>
		</div>
		...
		<div class="introduc-contact">
			...
			<div class="introduc-list">
				<ul>
					<li><i class="fas fa-map-marker-alt"></i> 66/30 Phổ Quang, Phường 2, Quận Tân Binh, TP Hồ Chí Minh.</li>
					<li><i class="fas fa-phone-volume"></i> 0928475944</li>
					<li><i class="fas fa-paper-plane"></i> houjiphoto@gmail.com
					</li>
				</ul>
			</div>
		</div>
