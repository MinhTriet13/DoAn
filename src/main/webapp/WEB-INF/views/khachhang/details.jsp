            ...
            <div class="list-product">
                ...
                <div class="item">
                    ...
                    <div class="item-images">
                        <a href="#"> <img src="${base }/img/zz.png" width="100%">
                        </a>
                    </div>
                    <div class="item-content">
                        <a href="#"> CASIO Z500 </a>
                        <div class="price">
                            <h4 class="new-price">490,000đ</h4>
                            <h5 class="old-price">490,000đ</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="item-images">
                        <a href="#"> <img src="${base }/img/coolpix.png"
                                          width="100%">
                        </a>
                    </div>
                    <div class="item-content">
                        <a href="#"> NIKON COOLPIX S620 </a>
                        <div class="price">
                            <h4 class="new-price">290,000đ</h4>
                            <h5 class="old-price">290,000đ</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="item-images">
                        <a href="#"> <img src="${base }/img/ff.png"
                                          width="100%">
                        </a>
                    </div>
                    <div class="item-content">
                        <a href="#"> FUJIFILM F30 </a>
                        <div class="price">
                            <h4 class="new-price">790,000đ</h4>
                            <h5 class="old-price">790,000đ</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="item-images">
                        <a href="#"> <img src="${base }/img/dmc.png"
                                          width="100%">
                        </a>
                    </div>
                    <div class="item-content">
                        <a href="#"> PANASONIC DMC LS1 </a>
                        <div class="price">
                            <h4 class="new-price">290,000đ</h4>
                            <h5 class="old-price">290,000đ</h5>
                        </div>
                ...
                <div class="item">
                    ...
                    <div class="item-images">
                        <a href="#"> <img
                                src="${base }/img/cybershot.png" width="100%">
                        </a>
                    </div>
                    <div class="item-content">
                        <a href="#"> SONY CYBERSHOT T100 </a>
                        <div class="price">
                            <h4 class="new-price">390,000đ</h4>
                            <h5 class="old-price">390,000đ</h5>
                        </div>
                    </div>
                </div>
